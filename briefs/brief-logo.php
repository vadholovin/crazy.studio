<?php
/*
Template Name: Бриф техзадания для логотипа
*/
?>
<!doctype html>
<html lang="ru">
  ...
  <body <?php body_class(); ?>>
    <div class="page">
          ...
          <div class="flex-container">
            <div class="page-header__text">
              <h1 class="page-header__title">
                <?php _e( 'Бриф', 'crazystudio' ); ?> <b><?php _e( 'технического задания', 'crazystudio' ); ?></b> <?php _e( 'для вашего', 'crazystudio' ); ?> <b><?php _e( 'логотипа', 'crazystudio' ); ?></b>
              </h1>
      ...
      <section class="brief">
        <div class="wrapper">
          <form action="<?php echo admin_url( 'admin-ajax.php?action=send_mail' ); ?>" class="brief-form" id="brief-form" method="POST" data-logo="data-logo" enctype="multipart/form-data">
            <input type="hidden" name="subject" value="Бриф технического задания для логотипа">
            <input type="hidden" name="current-form" value="logo">
            <div class="brief-slider">
                  ...
                  <div class="flex-container">
                    ...
                    <div class="form__item">
                      <label for="competitors" class="form__item-title">
                        - <?php _e( 'Укажите ссылки на сайты ваших прямых или косвенных конкурентов. Оцените их логотипы, укажите, что вам нравится, а что нет', 'crazystudio' ); ?>.
                      </label>
                ...
                <div class="brief-form__items form__items">
                  <div class="flex-container">
                    <div class="form__item">
                      ...
                      <div class="input-items input-items--horizontal mt-0">
              ...
              <div class="brief-slide" id="slide-4">
                <div class="brief-slide__title">
                  <div class="brief-slide__title-bkg"></div>
                  <h2>4 <?php _e( 'Постановка задачи', 'crazystudio' ); ?></h2>
                </div>
                  ...
                  <div class="flex-container">
                    <div class="form__item">
                      <label for="task" class="form__item-title require">
                        - <?php _e( 'Какую задачу вы ставите перед нами', 'crazystudio' ); ?>?
                      </label>
                      <textarea name="task" class="form__field form__field--small-mt" id="task"></textarea>
                    </div><!-- .form__item end -->
                  </div><!-- .flex-container end -->
                </div><!-- .brief-form__items end -->
              ...
              <div class="brief-slide last-slide" id="slide-5">
                <div class="brief-slide__title">
                  <div class="brief-slide__title-bkg"></div>
                  <h2>5 <?php _e( 'Дизайн', 'crazystudio' ); ?></h2>
                </div>

                <div class="brief-form__items form__items">
                  <div class="flex-container">
                    <div class="form__item">
                      <label for="current-style" class="form__item-title">
                        - <?php _e( 'В случае редизайна, приложите ссылку с логотипом и/или фирменным стилем', 'crazystudio' ); ?>.
                      </label>
                      <textarea name="current-style" class="form__field" id="current-style"></textarea>
                      <!-- <div class="upload-container" id="upload-container-$">
                        <input type="file" class="input-file" id="file-1" name="file_attach[]" accept=".jpg, .jpeg, .png, .psd, .doc, .docx, application/msword" multiple>
                        <label for="file-1" tabindex="0" class="input-file-trigger">Добавить файл</label>
                    ...
                    <div class="form__item">
                      <label for="cool-design" class="form__item-title require">
                        - <?php _e( 'Укажите примеры дизайна логотипа, которые нравятся (не обязательно компаний из вашей индустрии)', 'crazystudio' ); ?>. 
                      </label>
                      <textarea name="cool-design" class="form__field mt-0" id="cool-design"></textarea>
                    </div><!-- .form__item end -->

                    <div class="form__item">
                      <label for="shit-design" class="form__item-title">
                        - <?php _e( 'Укажите примеры дизайна логотипа, которые вам НЕ нравятся (не обязательно компаний из вашей индустрии)', 'crazystudio' ); ?>. 
                      </label>
