<?php
/*
Template Name: Бриф техзадания для лендинга
*/
?>
<!doctype html>
<html lang="ru">
  ...
  <body <?php body_class(); ?>>
    <div class="page">
          ...
          <div class="flex-container">
            <div class="page-header__text">
              <h1 class="page-header__title">
                <?php _e( 'Бриф', 'crazystudio' ); ?> <b><?php _e( 'технического задания', 'crazystudio' ); ?></b> <?php _e( 'для вашего', 'crazystudio' ); ?> <b><?php _e( 'лендинга', 'crazystudio' ); ?></b>
              </h1>
      ...
      <section class="brief">
        <div class="wrapper">
          <form action="<?php echo admin_url( 'admin-ajax.php?action=send_mail' ); ?>" class="brief-form" id="brief-form" method="POST" enctype="multipart/form-data" data-land="data-land">
            <input type="hidden" name="subject" value="Бриф технического задания для лендинга">
            <input type="hidden" name="current-form" value="land">
                  ...
                  <div class="flex-container">
                    ...
                    <div class="form__item">
                      <label for="info-blocks" class="form__item-title">
                        - <?php _e( 'Перечислите все информационные блоки, которые должны присутствовать на лендинге', 'crazystudio' ); ?>
                      </label>
                      <textarea name="info-blocks" class="form__field mt-0" id="info-blocks"></textarea>
