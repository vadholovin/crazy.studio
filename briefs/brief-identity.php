<?php
/*
Template Name: Бриф техзадания фирменного стиля
*/
?>
<!doctype html>
<html lang="ru">
  ...
  <body <?php body_class(); ?>>
    <div class="page">
          ...
          <div class="flex-container">
            <div class="page-header__text">
              <h1 class="page-header__title">
                <?php _e( 'Бриф', 'crazystudio' ); ?> <b><?php _e( 'технического задания фирменного', 'crazystudio' ); ?></b> <?php _e( 'стиля', 'crazystudio' ); ?>
              </h1>
      ...
      <section class="brief">
        <div class="wrapper">
          <form action="<?php echo admin_url( 'admin-ajax.php?action=send_mail' ); ?>" class="brief-form" id="brief-form" data-identity="data-identity" method="POST">
            <input type="hidden" name="subject" value="Бриф технического задания фирменного стиля">
            <input type="hidden" name="current-form" value="identity">
            <div class="brief-slider">
              ...
              <div class="brief-slide" id="slide-4">
                ...
                <div class="brief-form__items form__items">
                  <div class="flex-container">
                    <div class="form__item">
                      <label for="task" class="form__item-title">
              ...
              <div class="brief-slide" id="slide-5">
                ...
                <div class="brief-form__items form__items">
                  <div class="flex-container">
                    <div class="form__item">
                      <div class="form__item-title require">
                        - <?php _e( 'Есть ли логотип', 'crazystudio' ); ?>?
                      </div>
                    ...
                    <div class="form__item">
                      <div class="form__item-title">
                        - <?php _e( 'Если есть, нужно ли вносить изменения в логотип', 'crazystudio' ); ?>?
                      </div>
                      <div class="input-items">
                        <div class="input-item">
                          <label class="input-item__text">
                            <input class="input-item__radio" type="radio" name="edit-logo" value="да">
                            <div class="input-item__indicator input-item__indicator--radio"></div>
                            <?php _e( 'Да', 'crazystudio' ); ?>
                          </label>
                        </div>
                        <div class="input-item">
                          <label class="input-item__text">
                            <input class="input-item__radio" type="radio" name="edit-logo" value="нет">
                            <div class="input-item__indicator input-item__indicator--radio"></div>
                            <?php _e( 'Нет', 'crazystudio' ); ?>
                          </label>
                        </div>
                    ...
                    <div class="form__item">
                      <label for="link-logo" class="form__item-title">
                        - <?php _e( 'Если есть логотип, вставьте ссылку на него', 'crazystudio' ); ?>
                      </label>
                      <textarea name="link-logo" class="form__field" id="link-logo"></textarea>
                    </div><!-- .form__item end -->

                    <div class="form__item">
                      <label for="identity-products" class="form__item-title require">
                        - <?php _e( 'Перечислите на чём будет располагаться ваш фирменный стиль. Например визитки, майки, бейджи, кружки и так далее', 'crazystudio' ); ?>.
                      </label>
                      <textarea name="identity-products" class="form__field" id="identity-products"></textarea>
                    </div><!-- .form__item end -->
                  ...
                  <div class="flex-container">
                    <div class="form__item">
                      <label for="cool-design" class="form__item-title require">
                        - <?php _e( 'Укажите примеры фирменных стилей, которые вам нравятся (не обязательно компаний из вашей индустрии). Вставьте ссылку', 'crazystudio' ); ?>
                      </label>
                    ...
                    <div class="form__item">
                      <label for="shit-design" class="form__item-title">
                        - <?php _e( 'Укажите примеры фирменных стилей, которые вам НЕ нравятся (не обязательно компаний из вашей индустрии). Вставьте ссылку', 'crazystudio' ); ?>
                      </label>
                    ...
                    <div class="form__item">
                      <div class="form__item-title">
                        - <?php _e( 'Надо ли придерживаться текущего фирменного стиля (в случае редизайна)', 'crazystudio' ); ?>?
                      </div>
                      <div class="input-items mt-0">
                        <div class="input-item">
                          <label class="input-item__text">
